...
@app.route('/check_all')
def check_all():
  monit_result = Jpmonit.check_all(logger=app.logger)
...
def check_process():
  ...
  monit_result = Jpmonit.check_process(process, logger=app.logger)
  return return_result(monit_result)
...
def check_pid():
  ...
  monit_result = Jpmonit.check_pid(pid, logger=app.logger)
  return return_result(monit_result)
...
def check_pidfile():
  ...
  monit_result = Jpmonit.check_pidfile(pid_file_path, logger=app.logger)
  return return_result(monit_result)
